 ...
 * @return  void
 */
function nanofit_define_style( $selector, array $attributes ) {
...
function nanofit_scheme_styles() {
	global $wp_filesystem;
	
	if ( nanofit_initialize_filesystem_api() ) {
		$content = $wp_filesystem->get_contents( NANOFIT_PATH . 'assets/less/_color.less' );
		$colors  = nanofit_option( 'global__typography__scheme' );
 ...
 * @return  array
 */
function nanofit_typography_styles( array $options ) {
	$styles = array();

	if ( isset( $options['family'] ) && $family = nanofit_parse_font( $options['family'] ) ) {
...
function nanofit_parse_font( $font, $enqueue = true ) {
 ...
 * @return  array
 */
function nanofit_background_styles( $options ) {
	$styles = array();
 ...
 * @return  array
 */
function nanofit_border_styles( $options ) {
 ...
 * @return  string
 */
function nanofit_color_to_rgba( $color, $alpha ) {
